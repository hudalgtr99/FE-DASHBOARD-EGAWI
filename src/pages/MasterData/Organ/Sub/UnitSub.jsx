                ...
                <Form>
                  <div className="grid grid-cols-1 gap-4 bg-gray-100 p-2 rounded-lg">
                    ...
                    <div>
                      ...
                      <Field as="select" name="departemen" className="mt-1 block w-full rounded-md p-2 border border-black shadow-sm sm:text-sm">
                    ...
                    <div>
                      ...
                      <Field as="select" name="divisi" className="mt-1 block w-full rounded-md p-2 border border-black shadow-sm sm:text-sm">
                        <option value="" hidden label="Select Divisi" />
