	...
	const formik = useFormik({
		...
		validationSchema: Yup.object({
			...
			konfirmasi_password_baru: Yup.string()
				.oneOf([Yup.ref("password_baru"), null], "Password baru dan konfirmasi password tidak cocok")
			...
			<form onSubmit={formik.handleSubmit} className="space-y-4">
				<div className="relative">
					...
					{formik.touched.password_baru && formik.errors.password_baru && (
						<p className="text-red-500 text-sm">{formik.errors.password_baru}</p>
					)}
				</div>
				...
				<div className="relative">
					...
					/>
					{formik.touched.konfirmasi_password_baru && formik.errors.konfirmasi_password_baru && (
						<p className="text-red-500 text-sm">{formik.errors.konfirmasi_password_baru}</p>
					)}
				</div>
