				...
				<div className="p-6 bg-white dark:bg-base-600 rounded-lg shadow-lg">
					...
					<ul className="space-y-4">
						...
						<li className="flex justify-between">
							...
							<span className="text-gray-800  dark:text-base-100">{detailJobdesk?.jabatan_pegawai}</span>
						</li>
						<li className="flex justify-between">
							<span className="font-medium">Total Jobdesk:</span>
							<span className="text-gray-800  dark:text-base-100">{detailJobdesk?.total_jobdesk}</span>
						</li>
						<li>
