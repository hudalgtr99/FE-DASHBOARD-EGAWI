...
const Button = ({
  ...
  return (
    <button
      ...
      style={btnStyle}
      className={`outline-none tracking-wide duration-150 active:scale-[.98] active:duration-300 ${btnRounded} ${btnSize ? btnSize : ""
        } ${btnFixed ? "flex items-center justify-center" : ""} ${block ? "w-full" : ""
