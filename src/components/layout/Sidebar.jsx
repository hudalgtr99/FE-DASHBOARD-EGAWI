...
const Sidebar = () => {
	...
	const { sideOpen, setSideOpen, themeColor, colorMode, themeSkin, themeBg } = useContext(ThemeContext);
			...
			>
				...
				<div className="flex justify-between items-center w-full h-16 px-3 mx-auto">
					...
					<div className=" px-[8px]">
						<button className={`text-xl hidden lg:block ${!sideOpen && !openHover ? "lg:hidden" : ""}`}>
							{sideOpen ? (
				...
				{/* Menu */}
				<div ref={scrollbarContainer} className="relative flex-1 overflow-hidden group/rail">
